...
<aside id="logo-sidebar"
    ...
    <div class="h-full p-4 overflow-y-auto">
        ...
        <ul class="mt-4 space-y-2 font-medium">
            ...
            @endphp
            <li>
                <a href="/dashboard" class="flex items-center p-2 text-[#4B4B5A] hover:text-white hover:bg-blue-900 rounded-lg group transition-colors duration-200 {{ $berandaActive ? 'bg-blue-900 text-white' : '' }}">
                    <svg class="w-5 h-5 text-[#4B4B5A] group-hover:text-white {{ $berandaActive ? 'text-white' : '' }}" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 42 42">
            ...
            <li>
                <details class="group" {{ $isKaryawanActive ? 'open' : '' }}>
                    <summary class="flex items-center w-full p-2 text-base rounded-lg cursor-pointer transition-colors duration-200
                        ...
                        <a href="/karyawan" class="flex-1 ms-3 text-left whitespace-nowrap font-semibold">Karyawan</a>
                        <svg class="w-3 h-3 ms-auto transition-transform duration-300 group-open:rotate-180 {{ $isKaryawanActive ? 'text-white' : '' }}"
            ...
            <li>
                <details class="group" {{ $isPengaduanActive ? 'open' : '' }}>
                    <summary class="flex items-center w-full p-2 text-base rounded-lg cursor-pointer transition-colors duration-200
                        ...
                        <a href="/pengaduan" class="flex-1 ms-3 text-left whitespace-nowrap font-semibold">Pengaduan</a>
                        <svg class="w-3 h-3 ms-auto transition-transform duration-300 group-open:rotate-180 {{ $isPengaduanActive ? 'text-white' : '' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4"/>
                        </svg>
            ...
            <li>
                <details class="group" {{ $isSambunganActive ? 'open' : '' }}>
                    <summary class="flex items-center w-full p-2 text-base rounded-lg cursor-pointer transition-colors duration-200
                        ...
                        <a href="/sambungan" class="flex-1 ms-3 text-left whitespace-nowrap font-semibold">Sambungan</a>
                        <svg class="w-3 h-3 ms-auto transition-transform duration-300 group-open:rotate-180 {{ $isSambunganActive ? 'text-white' : '' }}"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4"/>
                        </svg>
